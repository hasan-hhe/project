                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            ...
                            <br>
                            <small>جديد (شهر): {{ $newApartmentsLastMonth }} | جديد (أسبوع): {{ $newApartmentsLastWeek }}</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            ...
                            <br>
                            <small>جديد (شهر): {{ $newBookingsLastMonth }} | جديد (أسبوع): {{ $newBookingsLastWeek }}</small>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-success">{{ number_format($apartment->rating_avg, 1) }}/5</span>
                                            </td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $booking->renter->first_name }} {{ $booking->renter->last_name }}</td>
